...
<div class="container-fluid">
	...
	<div class="row justify-content-center">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-3">
			...
			<div class="card mb-3">
				<div class="card-header bg-info text-white">CSV アップロード</div>
			...
			<div class="card mb-3">
				{{-- アップロード失敗 --}}
				@if($stMsgs['status'] == '0')
				<div class="card-header bg-danger text-white">アップロードエラーが発生しました。</div>
				...
				<div class="card-header bg-info text-white">アップロードに完了しました。</div>
			...
			<div class="card mb-3">
				...
				<div class="card-header bg-info text-white">処理結果詳細</div>
