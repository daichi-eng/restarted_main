...
// 			str_replace('>', '&gt;', $line);
		...
		for( $i = 0; $i < count($ary_s); $i++){
			...
			for ($j = 0; $j < count($ary_s[0]); $j++) {
				//1こ目の配列の値をキーとして、2個目からは値として格納する連想配列を作成。
		...
		// 			//配列を連想配列に変換する。
		// 			for ($j = 0; $j < count($array_s[0]); $j++) {
		// 				//1つ目の配列の値をキーとした連想配列を作成。更にその連想配列を多次元配列に格納していく。
		// 				$array_m[$i][$array_s[0][$j]] = $array_s[$i+1][$j];
		// 			}
		// 			echo strval($i);
		// 		}
		return $csvAry;
	 ...
	 * @return Array $reqAry
	 */
	public function nomal_stock_req($itemAry){
	 ...
	 * 選択肢別在庫の配列変換
	 * @param Array $itemAry
	 * @param Array $stockReArys
	 * @return Array $reqAry
	 */
	public function choices_stock_req($shopNum, $itemAry, $stockReArys = null){
...
// 				$xml3rd->addChild('stockShippingDayId', $itemAry['stockShippingDayId']);
// 				$xml3rd->addChild('stockShippingDayDispTxt', $itemAry['stockShippingDayDispTxt']);
// 				$xml3rd->addChild('stockCount', $itemAry['stockCount']);
// 				$xml3rd->addChild('displayStockSegment', $itemAry['displayStockSegment']);
// 				$xml3rd->addChild('displayStockThreshold', $itemAry['displayStockThreshold']);
...
// 				foreach($stockReArys as $stockReAry){
// 					//choicesStockHorizontals
// 					$xml3rd = $xml2nd->addChild('choicesStockHorizontals');
// 					$xml3rd->addChild('choicesStockHorizontalCode', $stockReAry['choicesStockHorizontalCode']);
// 					$xml3rd->addChild('choicesStockHorizontalName', $stockReAry['choicesStockHorizontalName']);
// 					$xml3rd->addChild('choicesStockHorizontalSeq', $stockReAry['choicesStockHorizontalSeq']);
						
						
// 					//choicesStockVerticals
// 					$xml3rd = $xml2nd->addChild('choicesStockVerticals');
// 						$xml3rd->addChild('choicesStockVerticalCode', $stockReAry['choicesStockVerticalCode']);
// 						$xml3rd->addChild('choicesStockVerticalName', $stockReAry['choicesStockVerticalName']);
// 						$xml3rd->addChild('choicesStockVerticalSeq', $stockReAry['choicesStockVerticalSeq']);
						
// 					//choicesStocks
// 					$xml3rd = $xml2nd->addChild('choicesStocks');
// 						$xml3rd->addChild('choicesStockVerticalCode', $stockReAry['choicesStockVerticalCode']);
// 						$xml3rd->addChild('choicesStockHorizontalCode', $stockReAry['choicesStockHorizontalCode']);
// 						$xml3rd->addChild('choicesStockCount', $stockReAry['choicesStockCount']);
// 						$xml3rd->addChild('choicesStockShippingDayId', $stockReAry['choicesStockShippingDayId']);
// 					$stockCnt = $stockCnt + 1;
// 				}
