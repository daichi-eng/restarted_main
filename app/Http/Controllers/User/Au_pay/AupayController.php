...
class AupayController extends Controller
{
	//au Payマーケット用のアプリNo
	...
	public function index()
	{
		...
		try {
			...
			return view('user.aupay.home', compact('stMsg', 'user' , 'shop'  ));
		}
	}
	...
	public function create_shop()
	{
		...
		//shop情報の存在の有無で分岐
		if(isset($shop[0]->id)){
			return view('user.aupay.create_shop', compact('user', 'shop'));
		}else{
			return view('user.aupay.create_shop', compact('user', 'shop'));
		}
	}
	 ...
	 * @return \Illuminate\Http\Response
	 */
	public function store_shop(Au_pay_store_validation $request)
	{
		$shop = new Shop;
		...
		return redirect('user/aupay/home');
	}
	...
	public function edit_shop($id)
	{
		...
		return view('user.aupay.edit_shop', compact('user', 'shop'));
	}
	 ...
	 * @return \Illuminate\Http\Response
	 */
	public function update_shop(Au_pay_update_validation $request, $id)
	{
		...
		return redirect('user/aupay/edit_shop/' .$id);
	}
